...
class RoomGrid(MultiGridEnv):
    ...
    def place_agent(
        self, agent: Agent, col: int | None = None, row: int | None = None, rand_dir: bool = True
    ) -> tuple[int, int]:
        """
    ...
    def add_distractors(
        self, col: int | None = None, row: int | None = None, num_distractors: int = 10, all_unique: bool = True
    ) -> list[WorldObj]:
        """
